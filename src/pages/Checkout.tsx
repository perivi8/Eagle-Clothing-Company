...
import { User, Building, Mail, Phone, MapPin, Package, Banknote } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center mb-6">
                <Banknote className="w-6 h-6 text-[#DAA520] mr-3" />
                <h2 className="text-xl font-semibold text-[#1C1C1C]">Payment Method</h2>
              </div>
              
              <div className="space-y-4">
                <label className="flex items-center p-4 border-2 border-[#DAA520] rounded-lg bg-[#DAA520] bg-opacity-5 cursor-pointer">
                  <input
                    type="radio"
                    name="paymentMethod"
                    value="cod"
                    ...
                    onChange={handleInputChange}
                    className="w-5 h-5 text-[#DAA520] focus:ring-[#DAA520]"
                  />
                  <div className="ml-4">
                    <span className="text-[#1C1C1C] font-medium">Cash on Delivery (COD)</span>
