...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: <Mail className="w-6 h-6" />,
      title: 'Email Us',
      primary: 'eagleclothingcompany2025@gmail.com',
      description: 'Alternative email for inquiries'
    },
    {
    ...
    },
    {
      ...
      primary: 'Monday - Sunday: 8:00 AM - 8:00 PM',
      description: 'Available all week for your inquiries'
    }
  ];
