            ...
            <div className="space-y-4 text-gray-700">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p>No. S1, 2nd Floor, Harini Apartments</p>
                  <p>P. No. 381, Nethaji Street,</p>
                  <p>Menambedu, Ambattur, Tiruvallur</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <Mail className="w-5 h-5 text-[#DAA520] mr-3" />
                <a href="mailto:eagleclothingcompany2025@gmail.com" className="hover:underline">
                  eagleclothingcompany2025@gmail.com
                </a>
              </div>
